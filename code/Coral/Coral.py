...
class Coral_blockchain:
    ...
    def txdl_handle_states(self):
        ...
        sns.histplot(data = df,x="deadline",hue="state",
                     hue_order=["pack_valid","vote_failed","pop_invalid"], multiple="stack")
        plt.savefig(self.data_path+"handle_state_DIstribution_{}_{}.jpg".format(
            config.getint("BH","low"),config.getint("BH","high")))
...
if __name__ == "__main__":
    ...
    cb = Coral_blockchain(config,data_path,send_rate)
