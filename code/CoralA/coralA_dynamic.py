...
class CAD_blockchain:
    ...
    def __init__(self,config,data_path) -> None:
        logging.info("*********** CAD_blockchain start ***********")
        self.config = config
    ...
    def sendTx(self):
        ...
        logging.info("not send tx:{}".format(len(self.tx_list)))
        has_tx = True
        ...
        logging.info("sendtx time:{}".format(time.time()-t0))
...
if __name__ == "__main__":
    ...
    cad = CAD_blockchain(config,data_path)
